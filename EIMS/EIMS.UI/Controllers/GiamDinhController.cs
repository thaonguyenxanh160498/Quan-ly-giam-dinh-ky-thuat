...
namespace EIMS.UI.Controllers
{
    ...
    [Route("{action}")]
    public class GiamDinhController : Controller
    {
        public EIMSEntities db = new EIMSEntities();
        [Route("giam-dinh/main-page")]
